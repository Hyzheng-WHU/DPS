...
protected[actions] trait PrimitiveActions {
  ...
  private def invokeSimpleAction(
    ...
    val startLoadbalancer =
      transid.started(this, LoggingMarkers.CONTROLLER_LOADBALANCER, s"action activation id: ${activationId}, args: ${args}")
    ...
    val message = ActivationMessage(
      ...
      // logging.info(this, s"message.args: ${message.content}")
